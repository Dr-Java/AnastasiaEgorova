package com.epam.tc.egorova.hw6.ex1;
...
public class ExerciseOneTest extends AbstractBaseSeleniumTest {

    @Test
    @Feature("Exercise one feature")
    @Story("Exercise one: Home Page")
